...
const ReviewManagement = () => {
  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_APP_BASE_URL}/reviews/all`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(`${import.meta.env.VITE_APP_BASE_URL}/reviews/update/${selectedReview._id}`, formData, {
        headers: {
  ...
  const handleDelete = async (reviewId) => {
    try {
      await axios.delete(`${import.meta.env.VITE_APP_BASE_URL}/reviews/delete/${reviewId}`);
      fetchReviews();
    } catch (error) {
