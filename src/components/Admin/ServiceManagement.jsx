...
const ServiceManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        await axios.put(`${import.meta.env.VITE_APP_BASE_URL}/services/update/${editId}`, form);
      } else {
        await axios.post(`${import.meta.env.VITE_APP_BASE_URL}/services/create`, form);
      }
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_APP_BASE_URL}/services/delete/${id}`);
      fetchServices();
    } catch (error) {
